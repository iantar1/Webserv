...
/*   Updated: 2024/06/02 14:07:56 by iantar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
    ...
    std::map<int, std::vector<ServerBlock> >    VserSimilars;//TODO 
private:
...
public:
    ...
    Request(int, ServerBlock , std::map<int, std::vector<ServerBlock> >);
    ~Request();
    ServerBlock Vserver;
    LocationBlock location;
    std::string newPath; // ! tmp
    std::string oldPath;
    std::string UriWithotLoc;
...
private:
    ...
    void checkRealPath(const std::string &);
    void checkReturn();
    void checkIfUriExist(const std::string);
...
public:
    ...
    // ************ exeption ***************
public:
    class DropClient : public std::exception
    {
    public:
